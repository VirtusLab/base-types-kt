...
//
//fun <S, E, S2, E2> MonoEither<E, S>.mapRight(mapper: (S) -> MonoEither<S2, E2>, errorMapper: (E) -> E2): MonoEither<S2, E2> = TODO()
//
//fun <S, E, S2, E2> MonoEither<E, S>.flatMapRight(mapper: (S) -> MonoEither<S2, E2>, errorMapper: (E) -> E2): MonoEither<S2, E2> = TODO()
//
//fun <S, E, S2, E2> MonoEither<E, S>.flatMapEither(mapper: (S) -> Either<S2, E2>, errorMapper: (E) -> E2): MonoEither<S2, E2> = TODO()
